...
function StatsCard({ title, value, change, icon: Icon, gradient, currency = false }: StatsCardProps) {
  ...
  return (
    <div className="rounded-xl shadow-sm border bg-white border-gray-200 p-6 hover:shadow-md transition-all">
